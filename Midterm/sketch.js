...
function preload(){
  ...
  //images of people
  cupidJack = loadImage('./characters-images/Cupid-Jack.png');
  cupidSammy = loadImage('./characters-images/Cupid-Sammy.png');
...
let phrases = [
  ...
  //Page 4 | 8 - 9
  "The flower base had disappeared and smoke and",
  "heart fragments had appeared.",
  //Page 5 | 10 - 11
  "The flower base had been turned into a card that",
  ...
  //Page 9 | 16
  "One of the witches said, “Your mine now midgets!",
  //Page 10 | 17
  ...
  //Page 14 | 23 - 25
  "One of the witches said, “perfect, these midgets",
  ...
  "together to make cards again, this time, the",
  "entrance got protected with a password code; only",
  "the ones authorized can enter the...",
  //page 30 | 59
  ...
  "Should we trust the door?",
  "Click to open the door to find out who knocked the door",
...
function draw() {
  ...
  //left bar
  rect(0,0,convert2Scalable(3,"width"),(height - dialogueBottomSize));
  //right bar
  ...
  if (linesUsing >= 1){
      if (usePlaceHolderPhrases == true){
        text('Line 1 test. This is the first line of text.', convert2Scalable(10,"x"), convert2Scalable(350,"y"));
         ...
         text(activePhrases[0], convert2Scalable(10,"x"), convert2Scalable(350,"y"));
      }
  }
  if (linesUsing >= 2){
      if (usePlaceHolderPhrases == true){
        ...
        text(activePhrases[1], convert2Scalable(10,"x"), convert2Scalable(380,"y"));
      }
  }
  if (linesUsing >= 3){
      if (usePlaceHolderPhrases == true){
        ...
        text(activePhrases[2], convert2Scalable(10,"x"), convert2Scalable(410,"y"));
      }
  }
  if (linesUsing >= 4){
      if (usePlaceHolderPhrases == true){
        ...
        text(activePhrases[3], convert2Scalable(10,"x"), convert2Scalable(440,"y"));
      }
  }
  ...
  text("Page " + curPage + "/" + maxPage, convert2Scalable(535,"x"), convert2Scalable(465,"y"));
  pop();
}
